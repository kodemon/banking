...
/*
    ...
    Account represents an entity that holds money calculated through JournalEntry movements for Transactions.
    
        public ICollection<AccountHolder> Holders
...
public class Account
{
    ...
    public ICollection<PersonalAccountHolder> PersonalHolders { get; set; } = new List<PersonalAccountHolder>();
    public ICollection<BusinessAccountHolder> BusinessHolders { get; set; } = new List<BusinessAccountHolder>();
