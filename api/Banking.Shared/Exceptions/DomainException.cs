...
public class ResourceNotFoundException(string message) : DomainException(message);

public class ResourceConflictException(string message) : DomainException(message);

public class ResourceDeletedException(string message) : DomainException(message);
